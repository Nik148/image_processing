...
plt.subplot(131), plt.imshow(v, cmap='gray'), plt.title('Исходное фото')
plt.subplot(132), plt.imshow(edges_subtraction, cmap='gray'), plt.title('Выделение границ вычитанием')
